...
<body>
    <div id="app" class="app-wrapper">
        ...
        <main class="main-body">
            ...
            <!-- ================= VIEW 5: VOLUNTEER DASHBOARD & ONBOARDING ================= -->
                    ...
                    <div class="responder-header-card volunteer-accent">
                        <div class="resp-header-left">
                            ...
                            <div>
                                ...
                                <h2 class="role-name-title">Ramesh Kulkarni (V-001) <span class="verified-pill">✓ VERIFIED</span></h2>
            ...
            <!-- ================= VIEW 7: COMMAND CENTER & AI INTELLIGENCE ================= -->
            <section id="command-view" class="content-view hidden" role="region" aria-label="Tactical Command Center">
                <div class="command-dashboard-layout">
                    ...
                    <!-- Command Resource Summary Metric Strip (Section 19) -->
                    ...
                    <div class="command-3col-grid" id="cmd-operations-subview">
                        ...
                        <div class="cmd-col-center">
                            ...
                            <!-- Command AI Recommendation Panel (Section 18) -->
        ...
        <!-- ================= 6. CREATE INCIDENT FOR PILGRIM MODAL (Section 9) ================= -->
        ...
        <!-- ================= 7. VOLUNTEER ONBOARDING MODAL (Section 4) ================= -->
...
print("Updated templates/index.html with full 12-step timeline, AI explainability panels, and modals!")
